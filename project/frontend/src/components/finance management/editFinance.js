...
const Service = () => {
    ...
    const handleDelete = (item) => {
        ...
        axios.delete(`http://localhost:5050/api/finance/${item._id}`)
        .then(() => {
      ...
      const handleUpdate = (event) => {
        ...
        axios.put(`http://localhost:5050/api/finance/${itemId}`, { amount, category, type, date, reference, description}).then(() => {
      ...
      const handleCreate = (event) => {
        event.preventDefault();
        axios.post('http://localhost:5050/api/finance/', { amount, category, type, date, reference, description }).then((response) => {
    ...
    const displayAllClients = () => {
        return data.map(user => (
            <tr key={user.id}>
                ...
                <td>
                <button  className="btn btn-success finance-edit-btn" onClick={() => handleEdit(user)}>Edit</button>
                {/* <button onClick={() => handleUpdate(item)}>Edit</button> */}
                <button className="btn btn-danger finance-delete-btn" onClick={() => handleDelete(user)}>Delete</button>
              </td>
                ...
                <div className="item">
                        ...
                        <div className="row">
                            <div className=" col-lg-6 col-md-12 col-sm-12">
                                ...
                                <div className="d-flex justify-content-start align-items-center">
                                        <button onClick={() => {
                                            generatePDF()
                                        }} id="btn-generate-report" className="btn me-3 mb-5">Generate Report
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row mt-6">
                        ...
                        <div className="table-responsive">
                            <table className="table  custom-table" id="assignLabsTable">
                                <thead>
                                    <tr>
                        ...
                        <div className="col">
                            <br />  <br />  <br />
                            <h1 className="text-center"><b>Edit Finance Details</b></h1>
