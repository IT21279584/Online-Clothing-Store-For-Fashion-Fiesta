  ...
  return (
    <div>
        ...
        <div className="container">
            ...
            <h5 className='subTitle text-center'> Please Update your Payment Info, </h5>
            <p> </p>
            <p> </p>

            {/* create all update payment form */}
            ...
            <form>
                ...
                <div className="form-check">
                    <center>
                        <Link to='../AllPayments.js'><button class="btn btn-primary" className = "my-btn" type="submit" onClick={(e)=>{UpdatePayment()}}> Upade my Payment Info </button></Link> {'  '}
                        <button class="btn btn-primary" className = "my-btn mb-5" type="reset"> Clear my Updated Payment Info </button>
                    </center>
                </div>
